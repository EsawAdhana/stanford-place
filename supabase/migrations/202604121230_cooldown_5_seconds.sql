...
revoke all on function public.place_pixel(uuid, integer, integer, integer, text, text) from anon;
revoke all on function public.place_pixel(uuid, integer, integer, integer, text, text) from authenticated;
grant execute on function public.place_pixel(uuid, integer, integer, integer, text, text) to service_role;
